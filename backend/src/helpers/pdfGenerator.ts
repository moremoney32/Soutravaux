...
// /**
//  * Générer un PDF pour une demande de prix
//  */
...
//       // Nom du fichier PDF — normaliser la référence pour éviter les caractères invalides
//       const sanitizeFileName = (name: string) => {
//         if (!name) return '';
//         // Remplacer caractères non autorisés par '-' et limiter la longueur
//         return name
//           .toString()
//           .normalize('NFKD')
//           .replace(/[<>:"/\\|?*\x00-\x1F]/g, '-')
...
//         doc
//           .fontSize(10)
//           .text(data.demande.adresse_livraison)
//           .moveDown(2);
//       } else {
//         doc
//           .fontSize(10)
//           .text('Adresse de livraison : Siège social')
//           .moveDown(2);
//       }
...
//         doc
//           .fontSize(14)
//           .text('Note générale :', { underline: true })
//           .moveDown(0.5);

//         doc
//           .fontSize(10)
//           .text(data.demande.note_generale)
//           .moveDown(2);
//       }
...
//       doc
//         .fontSize(14)
//         .text('Produits demandés :', { underline: true })
//         .moveDown(1);

//       // En-tête du tableau
//       const tableTop = doc.y;
//       const tableHeaders = ['Qté', 'Référence', 'Produit', 'Prix Unit.', 'Total'];
//       const colWidths = [40, 100, 200, 80, 80];
//       let xPos = 50;
...
//         // Securiser les valeurs de prix (peuvent être null/string) en les forçant en Number
//         const unitPrice = Number(ligne.public_price) || 0;
//         const total = Number(ligne.quantite) * unitPrice;

//         const row = [
//           ligne.quantite.toString(),
//           ligne.supplier_reference || 'N/A',
//           ligne.product_name,
//           `${unitPrice.toFixed(2)} €`,
//           `${total.toFixed(2)} €`
//         ];
...
//         row.forEach((cell, i) => {
//           doc
//             .rect(xPos, yPos, colWidths[i], lineHeight)
//             .stroke();
...
//         // Note de ligne (si présente)
//         if (ligne.note_ligne) {
//           doc
//             .fontSize(9)
//             .fillColor('gray')
//             .text(`Note : ${ligne.note_ligne}`, 55, yPos + 2);
//           yPos += 15;
//         }
...
//       // Résoudre la promesse une fois le fichier écrit
//       stream.on('finish', () => {
//         resolve(filepath);
//       });
