...
//     // Navigation simple entre 2 blocs
...
//     const prevInternalStep = () => {
//         setDirection("prev");
//         setInternalStep(1);
//     };

//     // Validation Étape 1 - Informations entreprise
...
//     // Validation complète pour l'envoi
//     const validateForm = (): boolean => {
//         const newErrors: { [key: string]: string } = {};
...
//                                 placeholder="123456789" 
//                                 value={checkSiret}
//                                 className="siret_number number1"
//                                 onChange={(e) => {
//                                     setCheckSiret(e.target.value);
//                                     if (!isSelectingSearch) {
//                                         setIsSelectingSearch(true);
...
//             {/* Navigation simple 2 étapes */}
//             {/* <div className="progress_container internal">
//                 <div className={`step ${internalStep === 1 ? "active" : ""}`}>
//                     Informations entreprise
//                 </div>
//                 <div className={`step ${internalStep === 2 ? "active" : ""}`}>
...
//                     </button>
//                 ) : (
//                     <button className="btn-back" onClick={prevInternalStep} disabled={loading}>
//                         Revenir
//                     </button>
//                 )}
