...
//     const [liens, setLiens] = useState<string[]>([]); // Stocker les liens
//     const [fichiers, setFichiers] = useState<string[]>([]); // Stocker les fichiers en commentaire
...
//         // Sauvegarder les liens et fichiers
//         onUpdate({ 
//             liens: liens,
//             fichiers: fichiers 
//         });
...
//     // Insérer le lien exactement comme saisi dans l'input
//     const handleInsertLien = (lienSaisi: string) => {
//         const newMessage = message + (message ? ' ' : '') + lienSaisi + ' ';
//         handleMessageChange(newMessage);
        
//         // Ajouter au tableau des liens pour l'affichage en bas
//         setLiens([...liens, lienSaisi]);
//         setShowModalLien(false);
//     };

//     // Insérer un fichier en commentaire (ne pas l'ajouter au message)
...
//     // Fonction pour formater l'affichage du message avec les liens cliquables
...
//                     <select className="select-campagne">
//                         <option>Choisissez un modèle de message</option>
//                         <option>Promotion -20%</option>
//                         <option>Rappel rendez-vous</option>
//                     </select>
//                     <button className="btn-primary btn-small-campagne">Appliquer</button>
//                 </div>
//             </div>
...
//             {/* AFFICHAGE DES LIENS ET FICHIERS INSÉRÉS */}
...
// src/components/campagne/Etape3Message.tsx
