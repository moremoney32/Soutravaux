...
const TimeRangePicker: React.FC<TimeRangePickerProps> = ({
  ...
  //   // Si durée invalide ou première fois, utiliser durée par défaut
  //   if (currentDuration <= 0) {
  //     const newEndTime = addMinutes(startTime, defaultDuration);
  //     onEndTimeChange(newEndTime);
  //   } else {
  //     // Maintenir la durée actuelle
  //     const newEndTime = addMinutes(startTime, currentDuration);
  //     onEndTimeChange(newEndTime);
  //   }
  // }, [startTime]); // ✅ Se déclenche uniquement quand startTime change
