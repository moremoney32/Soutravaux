...
export const PriceRequest = () => {
  ...
  useEffect(() => {
    ...
    // ✅ Tous les fournisseurs avec email (pas de filtre societe_id)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // ✅ Afficher snackbar success au lieu d'alert
  ...
  return (
    <div className="price-request-container">
      ...
      {/* ✅ Popup success - top right avec slide-in */}
      {showSuccessSnackbar && (
        <div className="price-request-success-popup">
          ...
          <button 
            className="price-request-success-popup-close" 
