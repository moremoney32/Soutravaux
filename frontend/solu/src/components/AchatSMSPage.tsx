...
const AchatSMSPage = () => {
 ...
 let userId = localStorage.getItem("membreId")
  let membreId = Number(userId)
      ...
      case 2:
        return (
          <Etape2Confirmation 
            ...
            membreId={membreId} // Passer le membre_id à la confirmation
          />
        );
      default:
        return null;
    ...
    return (
      <div className="page-achat-sms">
        <div className="error-container">
          ...
          <button className="btn-primary" onClick={() => navigate(`/campagne/${membreId}`)}>
            Retour à l'accueil
          </button>
        </div>
      </div>
